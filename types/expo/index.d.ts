...
// Definitions by: Ian J Sikes <https://github.com/ianjsikes>
...
declare module 'expo' {
    ...
    export interface AdMobBannerProps {
        ...
        admobDispatchAppEvent?: () => void;
    }

    export class AdMobBanner extends React.Component<AdMobBannerProps> {}

    export type PublisherBannerProps = AdMobBannerProps & {
        onAppEvent?: (event: { name: string; info: string }) => void;
        validAdSizes?: { width: number; height: number }[];
    };

    export class PublisherBanner extends React.Component<
        PublisherBannerProps
    > {}

    export enum InterstitialEvent {
        interstitialDidLoad = 'interstitialDidLoad',
        interstitialDidFailToLoad = 'interstitialDidFailToLoad',
        interstitialDidOpen = 'interstitialDidOpen',
        interstitialDidClose = 'interstitialDidClose',
        interstitialWillLeaveApplication = 'interstitialWillLeaveApplication',
    }

    export class AdMobInterstitial {
        static setAdUnitID: (adUnitID: string) => void;
        static setTestDeviceID: (deviceID: string) => void;
        static requestAd: (callback?: () => void) => void;
        static showAd: (callback?: () => void) => void;
        static isRead: (callback?: () => void) => void;

        static addEventListener: (
            event: InterstitialEvent,
            listener: (...args: any[]) => void
        ) => number;
        static removeEventListener: (id: number) => void;
    }

    export enum RewardedEvent {
        rewardedVideoDidRewardUser = 'rewardedVideoDidRewardUser',
        rewardedVideoDidLoad = 'rewardedVideoDidLoad',
        rewardedVideoDidFailToLoad = 'rewardedVideoDidFailToLoad',
        rewardedVideoDidOpen = 'rewardedVideoDidOpen',
        rewardedVideoWillLeaveApplication = 'rewardedVideoWillLeaveApplication',
    }

    export class AdMobRewarded {
        static setAdUnitID: (adUnitID: string) => void;
        static setTestDeviceID: (deviceID: string) => void;
        static requestAd: (callback?: () => void) => void;
        static showAd: (callback?: () => void) => void;
     ...
     */
        public static loadAsync(
            moduleIds: number | Array<number>
        ): Promise<void>;
    }

    export namespace Audio {
        export const setIsEnabledAsync: (value: boolean) => Promise<void>;
     ...
     */
        ...
        export class Recording {
            ...
            public setCallback(
                callback: (status: RecordingStatus) => any
            ): void;
            public setCallbackPollingMillis(millis: number): void;
    ...
    export namespace Brightness {
        ...
        export function setBrightnessAsync(
            brightnessValue: number
        ): Promise<void>;
        export function setSystemBrightnessAsync(
            brightnessValue: number
        ): Promise<void>;
    }
    ...
    export interface BarCodeScannerProps {
        ...
        onBarCodeRead: (arg: { type: string; data: string }) => void;
        style: ViewStyle;
    }
   ...
   */
    ...
    export namespace Font {
        ...
        export function processFontFamily(
            name?: string | null
...
declare module '@expo/vector-icons' {
    ...
    export class MaterialComunityIcons extends Component<
